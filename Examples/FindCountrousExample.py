...
import media_pumpkin       # Importing the cvzone library for additional functionalities
import numpy as np  # Importing NumPy library for numerical operations

# Download an image containing shapes from a given URL
imgShapes = media_pumpkin.downloadImageFromUrl(
...
imgContours, conFound = media_pumpkin.findContours(
...
imgContoursFiltered, conFoundFiltered = media_pumpkin.findContours(
    imgShapes, imgDilated, minArea=1000, sort=True,
