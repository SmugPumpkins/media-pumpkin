...
import mediapy       # Importing the cvzone library for additional functionalities
import numpy as np  # Importing NumPy library for numerical operations

# Download an image containing shapes from a given URL
imgShapes = mediapy.downloadImageFromUrl(
...
imgContours, conFound = mediapy.findContours(
...
imgContoursFiltered, conFoundFiltered = mediapy.findContours(
    imgShapes, imgDilated, minArea=1000, sort=True,
